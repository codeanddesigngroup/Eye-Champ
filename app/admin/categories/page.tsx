    ...
    <section className="np-workspace">
      ...
      <div className="categories-content">
        ...
        <section className="categories-panel">
          ...
          <div className="categories-tools"><label><Search size={16} /><input value={query} onChange={event => setQuery(event.target.value)} placeholder="Search categories" /></label><select value={status} onChange={event => setStatus(event.target.value)}><option>All statuses</option><option>Active</option><option>Draft</option></select><select><option>All types</option><option>Manual</option><option>Smart</option></select></div>
